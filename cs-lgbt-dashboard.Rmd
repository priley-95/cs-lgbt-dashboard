...
### Ethnicity & bullying data
```{r}
library(plotly)
#Create graph with ethnicity and bullying data
p <- ggplot(EthnicityBullying, aes(x = Demo_response, y = percentage)) +
...
* PROVISIONAL / NOT QA'd *

This graph shows ethnicity & bullying data for LGB staff respondents, from the CS People Survey 20xx. 


### Sexual orientation & bullying, by department
...
This graph shows sexual orientation and bullying data for LGB staff respondents, from the CS People Survey 20xx.


### Sexual orientation and bullying, by department

```{r}
p3 <- ggplot(orgBullyingGroup, aes(x = OrgGroup, y = Average)) +
  geom_bar(stat = "identity") +
...
This graph shows the median percentage of LGB+ colleagues bullied (from CS People Survey 20xx data), split by department. 
